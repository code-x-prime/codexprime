...
const projects: Project[] = [
    ...
    },
    {
        ...
        description: 'At Pure Earth Cleanings, we’ve been delivering professional cleaning services across Australia for over 10 years. Whether it’s your home, office, gym, restaurant, or childcare center — we’re committed to providing spotless results every time.',
        image: 'https://pub-a3d2b35862c1483894ffbee942bb995e.r2.dev/pureearthcleaning.png',
        tags: ['Wordpress', 'Elementor Pro', 'PHP'],
        results: 'Professional cleaning services across Australia',
